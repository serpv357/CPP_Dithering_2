...
#ifndef CPP_DITHERING_2_FLOSTE_DITHER_H
#define CPP_DITHERING_2_FLOSTE_DITHER_H
...
int __getDiffBetweenPixels(cv::Vec3b *oldPixel, cv::Vec3b *newPixel) {
    int b = (*oldPixel)[0] - (*newPixel)[0];
    int g = (*oldPixel)[1] - (*newPixel)[1];
    int r = (*oldPixel)[2] - (*newPixel)[2];
...
#endif //CPP_DITHERING_2_FLOSTE_DITHER_H
